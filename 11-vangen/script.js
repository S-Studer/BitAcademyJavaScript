function gooiButton() {
    try {
        ...
        document.getElementById("text").innerHTML = "Fout, je hebt de bal al gegooid";
    }
}
...
function vangButton() {
    try {
        ...
        document.getElementById("text").innerHTML = "Fout, de bal zit niet in de lucht";
    }
}
...
function resetButton() {
    try {
        ...
        document.getElementById("text").innerHTML = "Fout, je hebt de bal al gereset";
    }
}
